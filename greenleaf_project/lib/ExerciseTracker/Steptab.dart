...
import 'package:greenleaf_project/ExerciseTracker/SeeAllStepsData.dart';
import 'package:greenleaf_project/ExerciseTracker/stepinsight.dart';
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>  const Seeallstepsdata()));
                },
                child: Container(
                    height: 40,
                    width: 120,
