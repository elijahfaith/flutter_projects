...
import 'package:greenleaf_project/Wellbeing/sleep_insight_chart.dart';
import 'package:greenleaf_project/Wellbeing/sleep_see_all.dart';
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(width: 1, color: lightPurple,), borderRadius: const BorderRadius.only(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>  const SleepSeeAll()));
                },
                child: Container(
                    height: 40,
                    width: 120,
